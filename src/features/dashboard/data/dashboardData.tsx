...
export const actionAlerts = [
  {
    id: 1,
    icon: <FluentIcon name="notification" size={28} />,
    priority: '긴급',
  ...
  {
    id: 2,
    icon: <FluentIcon name="skipnext" size={28} />,
    priority: '주의',
  ...
  {
    id: 3,
    icon: <FluentIcon name="upload" size={28} />,
    priority: '정보',
  ...
  {
    id: 4,
    icon: <FluentIcon name="alarm" size={28} />,
    priority: '주의',
    priorityColor: 'warning' as const,
  ...
  {
    id: 5,
    icon: <FluentIcon name="search" size={28} />,
    priority: '정보',
    priorityColor: 'info' as const,
    title: '자동 검증 진행 중',
  ...
  {
    id: 6,
    icon: <FluentIcon name="lightbulb" size={28} />,
    priority: '정보',
    priorityColor: 'info' as const,
...
export const summaryCards = [
  { label: '총 견적서', value: `${summaryData.totalEstimates}건`, icon: <FluentIcon name="document" size={28} />, color: '#e60012' },
  { label: '검증 완료율', value: `${summaryData.verificationRate}%`, icon: <FluentIcon name="check" size={28} />, color: '#0056a6' },
  { label: '이상치 발견', value: `${summaryData.anomalies}건`, icon: <FluentIcon name="warning" size={28} />, color: '#0070d4' },
  { label: '평균 생산원가', value: `₩${summaryData.averageCost}천`, icon: <FluentIcon name="money" size={28} />, color: '#2196f3' },
];
