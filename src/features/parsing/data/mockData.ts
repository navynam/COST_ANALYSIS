...
export const initialFiles: FileItem[] = [
  ...
  // ── 추출완료 ──
  { id: 2,  name: 'HEAD_LINING_원가계산서.xlsx',      status: 'verifying',  progress: 100, parsedItems: 24,   anomalies: 2,    uploadDate: '2026-02-18', fileSize: '3.1 MB', sheets: 4, uploader: '박지혜', department: '원가관리팀', attachments: ['HEAD_LINING_집계표.xlsx'] },
  ...
  // ── 검증대기 ──
  { id: 3,  name: 'DOOR_TRIM_견적서.xlsx',            status: 'verified',   progress: 100, parsedItems: 18,   anomalies: 0,    uploadDate: '2026-02-17', fileSize: '1.8 MB', sheets: 2, uploader: '이철수', department: '구매팀', attachments: ['DOOR_TRIM_집계표.xlsx'] },
  { id: 8,  name: 'HOOD_INNER_원가계산서.xlsx',       status: 'verified',   progress: 100, parsedItems: 22,   anomalies: 3,    uploadDate: '2026-02-12', fileSize: '3.5 MB', sheets: 4, uploader: '이분석', department: '견적1팀', attachments: ['HOOD_INNER_집계표.xlsx'] },
  ...
  // ── 검증완료 ──
  { id: 5,  name: 'BUMPER_ASSY_Q4견적.xlsx',          status: 'analyzed',   progress: 100, parsedItems: 32,   anomalies: 0,    uploadDate: '2026-02-15', fileSize: '2.9 MB', sheets: 3, uploader: '최민정', department: '원가관리팀', attachments: ['BUMPER_ASSY_집계표.xlsx'] },
