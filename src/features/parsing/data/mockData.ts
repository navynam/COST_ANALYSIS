...
export const statusConfig: Record<FileStatus, { label: string; emoji: string; color: string }> = {
  ...
  verifying: { label: '검증중', emoji: '🔍', color: '#3B82F6' },
  verified: { label: '검증완료', emoji: '✅', color: '#0D9488' },
  analyzing: { label: '분석중(자동)', emoji: '🟣', color: '#8B5CF6' },
  inAnalysis: { label: '분석중', emoji: '🔬', color: '#6366F1' },
  analyzed: { label: '분석완료', emoji: '📊', color: '#10B981' },
